...
export function SuppliersPanel({ chrome }: PanelProps) {
  ...
  if (!allowed) {
    return (
      <ThreePane tabs={chrome}
        context={<div />}
      >
        <PageHeader eyebrow="Pharmacy" title="Suppliers" />
        <Notice tone="bad">Suppliers are kept by the pharmacy or an administrator.</Notice>
      </ThreePane>
    );
  }
  ...
  return (
    ...
    >
      <PageHeader eyebrow="Pharmacy" title="Suppliers" sub={session?.staffName} />
